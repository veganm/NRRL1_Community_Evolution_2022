...
pMuMax.AA<-subset(NRRL1.growth.mumax, species=="AA") %>%
  ...
  theme(axis.text=element_text(size=xTextSize), 
        ...
        legend.title=element_blank(),
        legend.position = "none") +
  labs(title=expression(italic("A. aurescens")), x="", y="r")+
  stat_compare_means(label.y = 0.05, label.x=1.1) 
pMuMax.AA

pMuMax.CG<-subset(NRRL1.growth.mumax, species=="CG") %>%
  ggplot(aes(x=strain, y=mumax, color=strain))+
  geom_boxplot(fill=NA)+
  geom_point(size=3) + theme_classic()+
  ylim(0, 0.4)+
  theme(axis.text=element_text(size=xTextSize), 
        ...
        legend.title=element_blank(),
        legend.position = "none") +
  labs(title=expression(italic("C. gleum")), x="", y="r") +
  #stat_compare_means(aes(label=..p.adj..), ref.group = "CG.0", method.args=list(p.adjust.method="bonferroni")) + 
  stat_compare_means(label.y = 0.05, label.x=1.8) 
pMuMax.CG

pMuMax.MO<-subset(NRRL1.growth.mumax, species=="MO") %>%
  ggplot(aes(x=strain, y=mumax, color=strain))+
  geom_boxplot(fill=NA)+
  geom_point(size=3) + theme_classic()+
  ylim(0, 0.4)+
  theme(axis.text=element_text(size=xTextSize), 
        ...
        legend.title=element_blank(),
        legend.position = "none") +
  labs(title=expression(italic("M. oxydans")), x="", y="r") +
  #stat_compare_means(aes(label=..p.adj..), ref.group = "MO.0", method.args=list(p.adjust.method="bonferroni")) + 
  stat_compare_means(label.y = 0.3, label.x=1.8) 
pMuMax.MO

#my_comparisons<-list(c('PM.A1.5', 'PM.A1.9'),c('PM.A2.5', 'PM.A2.9'),c('PM.I1.5', 'PM.I2.9'), c('PM.I2.5', 'PM.I2.9'), c('PM.A1.9', 'PM.I2.9'),c('PM.A2.9', 'PM.I2.9'))
pMuMax.PM<-subset(NRRL1.growth.mumax, species=="PM") %>%
  ggplot(aes(x=strain, y=mumax, color=strain))+
  geom_boxplot(fill=NA)+
  geom_point(size=3) + theme_classic()+
  ylim(0, 0.4)+
  theme(axis.text=element_text(size=xTextSize), 
        ...
        legend.title=element_blank(),
        legend.position = "none") +
  labs(title=expression(italic("P. mosselii")), x="", y="r") +
  #stat_compare_means(aes(label=..p.adj..), ref.group = ".all.", method.args=list(p.adjust.method="bonferroni")) + 
  stat_compare_means(label.y = 0.05, label.x=1.3) 
pMuMax.PM

################ now plot K
plogistic.K.AA<-subset(NRRL.logistic, Species=="AA") %>%
  ggplot(aes(x=Strain, y=k, color=Strain))+
  geom_boxplot(fill=NA)+
  geom_point(size=3) + theme_classic()+ 
  #ylim(0.3,0.8)+
  theme(axis.text=element_text(size=xTextSize),
        ...
        legend.title=element_blank(),
        legend.position = "none") +
  labs(title=expression(italic("A. aurescens")), y="K (OD600)",x="") +
  #  stat_compare_means(aes(label=..p.adj..), ref.group = "AA.0", method.args=list(p.adjust.method="bonferroni")) + 
  stat_compare_means(label.y = 0.75, label.x=1.1) 
plogistic.K.AA

plogistic.K.CG<-subset(NRRL.logistic, Species=="CG") %>%
  ggplot(aes(x=Strain, y=k, color=Strain))+
  geom_boxplot(fill=NA)+
  geom_point(size=3) + theme_classic()+ 
  #ylim(0.25,0.55)+
  theme(axis.text=element_text(size=xTextSize),
        ...
        legend.title=element_blank(),
        legend.position = "none") +
  labs(title=expression(italic("C. gleum")), y="K (OD600)",x="") +
  #  stat_compare_means(aes(label=..p.adj..), ref.group = "CG.0", method.args=list(p.adjust.method="bonferroni")) + 
  stat_compare_means(label.y = 0.53, label.x=1.8) 
plogistic.K.CG

plogistic.K.MO<-subset(NRRL.logistic, Species=="MO") %>%
  ggplot(aes(x=Strain, y=k, color=Strain))+
  geom_boxplot(fill=NA)+
  geom_point(size=3) + theme_classic()+
  #ylim(0.2,0.35)+
  theme(axis.text=element_text(size=xTextSize),
        ...
        legend.title=element_blank(),
        legend.position = "none") +
  labs(title=expression(italic("M. oxydans")), y="K (OD600)",x="") +
  #  stat_compare_means(aes(label=..p.adj..), ref.group = "AA.0", method.args=list(p.adjust.method="bonferroni")) + 
  stat_compare_means(label.y = 0.48, label.x=2.3) 
plogistic.K.MO

plogistic.K.PM<-subset(NRRL.logistic, Species=="PM") %>%
  ggplot(aes(x=Strain, y=k, color=Strain))+
  geom_boxplot(fill=NA)+
  geom_point(size=3) + theme_classic()+ 
  #ylim(0.05,0.2)+
  theme(axis.text=element_text(size=xTextSize),
        ...
        legend.title=element_blank(),
        legend.position = "none") +
  labs(title=expression(italic("P. mosselii")), y="K (OD600)",x="") +
 # stat_compare_means(aes(label=..p.adj..), ref.group = "PM.A1.5", method.args=list(p.adjust.method="bonferroni")) + 
  stat_compare_means(label.y = 0.1, label.x=1.3) 
plogistic.K.PM

pLogisticParams<-plot_grid(pMuMax.AA, pMuMax.CG, pMuMax.MO, pMuMax.PM,
